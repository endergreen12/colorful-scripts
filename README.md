...
The reason for this change is that the UI-related code was making the scripts unnecessarily complex. I plan to re-implement this once I find a better, cleaner approach.it.
